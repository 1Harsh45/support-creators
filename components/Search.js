  ...
  return (
    ...
    <div className="relative inline-block">
      ...
      <button
        ...
        className="text-white mx-1 md:mx-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs md:text-sm px-3 md:px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-2  transform transition duration-300 hover:scale-105 hover:shadow-lg focus:outline-none"
        type="button"
