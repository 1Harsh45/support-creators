    ...
    <nav className="">
      <div className="bg-gray-900 text-white flex justify-between items-center px-5 md:px-10 pt-2 h-16">
        <div className="logo font-bold md:text-lg ">
          <Link href={'/'}>
            <span className="hidden md:block pb-2">SupportCreators!</span>
            <span className=" block md:hidden">
            <img
              src="/hand.gif" alt=""
              className="bg-blend-luminosity w-[60px] pb-2"
            />
          </span>
              </Link>
          </div>
...
{/* ******************************************* */}
              ...
              <button
                type="button"
                 className="text-white bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 font-medium rounded-lg text-sm px-6 py-2.5 shadow-md transform transition duration-300 hover:scale-105 hover:shadow-lg focus:outline-none hidden"
                onClick={() => signOut()}
              >
                {" "}
                LogOut
